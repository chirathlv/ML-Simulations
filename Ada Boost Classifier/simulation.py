...
num_estimators = int(input('Enter number of estimators (example 50): '))

for i, _ in enumerate(data):
    # Model
    model = AdaBoostClassifier(n_estimators=num_estimators, random_state=0)
    ...
    # Decision Boundries
    plt.title("Ada Boost Classifier Simulation", fontweight='bold')

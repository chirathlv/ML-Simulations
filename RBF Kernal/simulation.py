...
for i, _ in enumerate(data):
    if i > 10: # Classifier requires at least 2 classes so skipping some iterations
        # Model
        kernel = 1.0 * RBF(1.0)
        ...
        # Decision Boundries
        plt.title("Gaussian Process Classifier (with RBF Kernel) Simulation", fontweight='bold')
